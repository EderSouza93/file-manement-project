        ...
        try {
            switch(choice) {
                case '1':
                    ...
                    const createFilePath = path.join(baseDir, fileName) // Salva o arquivo na pasta local onde está rodando a aplicação
                ...
                case '5':
                    ...
                    const messageDeleted = await fileManager.deleteFile(deleteFilePath)
